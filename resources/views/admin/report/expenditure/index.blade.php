...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        <h4 class="pull-left page-title bread_title">Report Expenditure</h4>
        <ol class="breadcrumb pull-right">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li class="active"> Report Expenditure</li>
        </ol>
    </div>
</div>
<!-- add division -->
      ...
      <form class="form-horizontal" id="registration" target="_blank" action="{{ route('report-expenditure-process') }}" method="post">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fab fa-gg-circle"></i> Report Expenditure</h3>
                    </div>
