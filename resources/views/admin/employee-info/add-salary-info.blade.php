        ...
        <form class="form-horizontal" id="salary-details-form" method="post" action="{{ route('salary-detalis-insert') }}">
          ...
          <div class="card">
              ...
              <div class="card-body card_form">
                ...
                <input type="hidden" name="empId" value="{{ $insert }}">
                ...
                @if ($employee->hourly_employee == 1)
                  ...
                  <div class="form-group row custom_form_group{{ $errors->has('hourly_rate') ? ' has-error' : '' }}" >
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" name="hourly_rate" value="{{old('hourly_rate')}} 0" min="0">
                ...
                @else
                  ...
                  @if($employee->emp_type_id == 1)
                    <div class="form-group row custom_form_group{{ $errors->has('basic_amount') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-7">
                          <input type="text" placeholder="Input Amount" class="form-control" id="basic_amount" name="basic_amount" value="{{ old('basic_amount') }} 0" min="0" onkeyup="hourlyRate()">
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('basic_hours') ? ' has-error' : '' }}" >
                        ...
                        <div class="col-sm-7">
                          <input type="text" placeholder="Input Basic Hours" class="form-control" id="basic_hours" name="basic_hours" value="{{old('basic_hours')}} 0" min="1">
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('hourly_rate') ? ' has-error' : '' }}" >
                        <label class="col-sm-3 control-label" for="basic_hours">Hourly Rate:<span class="req_star">*</span></label>
                        <div class="col-sm-7">
                          <input type="text" placeholder="Input Hours Rate" class="form-control" id="hourly_rate" name="hourly_rate" value="{{old('hourly_rate')}} 0" min="0">
                  ...
                  @else
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('house_rent') ? ' has-error' : '' }}" >
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" name="house_rent" value="{{old('house_rent')}} 0" min="0">
                          @if ($errors->has('house_rent'))
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $errors->first('hourly_rate') }}</strong>
                              </span>
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('mobile_allowance') ? ' has-error' : '' }}" >
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" name="mobile_allowance" value="{{old('mobile_allowance')}} 0" min="0">
                          @if ($errors->has('mobile_allowance'))
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $errors->first('mobile_allowance') }}</strong>
                              </span>
                    ...
                    <div class="form-group row custom_form_group{{ $errors->has('local_travel_allowance') ? ' has-error' : '' }}" >
                        ...
                        <div class="col-sm-7">
                          <input type="text" class="form-control" name="local_travel_allowance" value="{{old('local_travel_allowance')}} 0" min="0">
