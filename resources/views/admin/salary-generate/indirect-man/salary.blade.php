                      ...
                      <table class="table table-responsive salary__table">
                          <thead>
                              ...
                              <tr class="first-head-row">
                                  ...
                                  <th> <span>Trv Allo</span> </th>
                                  <th> <span>Fd Allo</span> </th>


                                  <th> <span>Othr</span> </th>
                                  <th> <span>Iqa Rnwl</span> </th>
                                  <th> <span>Adv1</span> </th>
                          ...
                          <tbody>
                            <tr class="salary-row-parent">
                              ...
                              <tr class="second-row">
                                  ...
                                  <td></td>
                                  <td></td>
                                  <td> <span class="basic-salary-data">{{ $salaryReport->basic_amount }}</span> </td>
                                  <td> <span class="mobile-data">{{ $salaryReport->mobile_allowance }}</span> </td>




                                  <td> <span class="travel-data">{{ $salaryReport->local_travel_allowance }}</span> </td>
                                  <td> <span class="food-data">{{ $salaryReport->food_allowance }}</span> </td>


                                  <td> <span class="others-data">{{ $othersAmount }}</span> </td>
                                  <td> <span class="medical-data">{{ $salaryReport->slh_iqama_advance }}</span> </td>
                                  <td> <span>300</span> </td>
