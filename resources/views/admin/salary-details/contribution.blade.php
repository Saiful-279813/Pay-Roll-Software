        ...
        $.ajax({
          ...
          success:function(response){
            if(response.data){
              ...
              $('input[id="emplIdShow"]').val(response.data.employee.emp_auto_id);
              $('input[id="employeeName"]').val(response.data.employee.employee_name);
              $('input[id="employeeIQama"]').val(response.data.employee.akama_no);
              $('input[id="contributionAmount"]').val(response.data.cpf_contribution);
              $('input[id="saudiTax"]').val(response.data.saudi_tax);
            }else{
